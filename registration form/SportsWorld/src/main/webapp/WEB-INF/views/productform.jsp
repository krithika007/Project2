...
<br><br>
<tr>
<td><h3>Enter Product Name </h3></td><td> <form:input  type="name" class="form-control" placeholder="Enter Product Name" path="productName"/>
...
<tr>
<td>
<h3>Enter Description </h3></td> <td> <form:textarea  class="form-control" placeholder="Description" rows="4" cols="50" path="description"/>
<form:errors path="description" style="color:red"></form:errors></td></tr>
<tr>
<td>
<br><br>

<h3>Select Category:</h3><h4><c:forEach items="${categories }" var="c">
<form:radiobutton path="category.id" value="${c.id }"/>${c.categoryName }</c:forEach></h4>
