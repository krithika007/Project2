...
private SessionFactory sessionFactory;
	...
	"select * from Users where username in (select username from Users where username!=? minus (select fromId from  Friend where toId=? union select toId from  Friend where fromId=?))");
